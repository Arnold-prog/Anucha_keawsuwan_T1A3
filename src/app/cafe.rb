...
$item_names = {"l"=> "Lick my paws", "s"=> "Scooby Snacks", "t"=> "Tofu Special", "q"=> "Quit"}
$order_hash = {}
$password = "password"

 def main() #This method is where the menu will show up for their options 
	quit = false
	until quit
		print_intro()
		resp = user_option()
...
def user_option()
	...
	puts " "
    puts "Order? or Quit? Please type answer below"
    puts " "
...
def staff_mode() #Method for staff mode allows add, remove and change menu.
	system "clear"
...
def print_staff() #shows them in staff mode
	system "clear"
	puts "Staff Mode"
	puts " "
	print_options()
...
def staff_change_price() #methos to change pirce 
	print_staff()
	puts " "
